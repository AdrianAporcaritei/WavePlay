...
import com.GarajM.WavePlay.dto.response.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleEmailAlreadyExcistsException (EmailAlreadyExistsException ex, WebRequest request){
    ...
    public ResponseEntity<ErrorResponse> handleResourseNotFoundException(ResourceNotFoundException ex, WebRequest request){
    ...
    public ResponseEntity<ErrorResponse> handleRuntimeException(RuntimeException ex, WebRequest request){
        logger.error("Runtime exception accured: {}", ex.getMessage(), ex );
